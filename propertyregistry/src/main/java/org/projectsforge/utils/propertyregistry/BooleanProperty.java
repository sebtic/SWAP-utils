...
public class BooleanProperty extends Property<Boolean> {
  ...
  public BooleanProperty(final ValueHolder valueHolder, final Boolean defaultValue) {
    super(valueHolder, false);
    setDefaultValue(serialize(defaultValue));
  }

  @Override
  protected Boolean deserialize(final String value) {
    return Boolean.parseBoolean(value);
  }

  @Override
  protected String serialize(final Boolean value) {
